...
export class PlanetsTableComponent implements OnInit {
  ...
  columnsToDisplay = ['name', 'terrain', 'population', 'residents amount', 'films amount'];
    ...
    this.planetsService.getPlanets()
      .subscribe(planets => {
        ...
        this.planetsList = planets
          .map(planet => ({ ...planet, ['residents amount']: planet.residents.length, ['films amount']: planet.films.length }));
      });
  }
}
